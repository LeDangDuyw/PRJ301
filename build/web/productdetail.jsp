...
<div class="cnt">
  ...
  <div class="rel-wrap">
    ...
    <div class="rel-grid">
      ...
      <a href="${pageContext.request.contextPath}/product-detail?id=${p.id}" class="rel-card">
        <div class="rel-img">
...
function addToCart(id){
  ...
  setTimeout(function(){btn.innerHTML='🛒 Thêm vào giỏ hàng';btn.style.background='';},2000);
}
